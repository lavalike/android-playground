...
import com.android.exercise.ui.widget.PullLayout;
...
public class PullActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webview.loadUrl(url);
        View behindView = pullLayout.getBehindView();
        if (behindView != null) {
            ((TextView) behindView.findViewById(R.id.tv_tip)).setText(getUrlHost(url));
        }
    }
