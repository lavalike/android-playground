...
package com.android.playground.ui.widget.swipebacklayout;
...
public class ViewDragHelper {
    ...
    /**
     * Apps should use ViewDragHelper.create() to getClient a new instance. This will
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            // Reset things for a new event stream, just in case we didn't getClient
